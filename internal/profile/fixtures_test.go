...
var knownFixtureMappings = map[string]struct{}{
	"MAP-AUTH-001":                  {},
	"MAP-BUCKET-BILLING-001":        {},
	"MAP-BUCKET-INFO-001":           {},
	"MAP-BUCKET-QUOTA-001":          {},
	"MAP-CLUSTER-CAPACITY-001":      {},
	"MAP-CLUSTER-HEALTH-001":        {},
	"MAP-NAMESPACE-BILLING-001":     {},
	"MAP-NAMESPACE-INFO-001":        {},
	"MAP-NAMESPACE-PERFORMANCE-001": {},
	"MAP-NAMESPACE-QUOTA-001":       {},
	"MAP-NODE-DISK-001":             {},
	"MAP-NODE-RESOURCE-001":         {},
	"MAP-RECOVERY-001":              {},
	"MAP-REPLICATION-001":           {},
	"MAP-VDC-PERFORMANCE-001":       {},
	"MAP-VERSION-001":               {},
}
...
func TestRepositoryFixtureContracts(t *testing.T) {
	...
	err := filepath.WalkDir(fixtureRoot, func(path string, entry fs.DirEntry, walkErr error) error {
		...
		case "manifest.json":
			manifestCount++
			fixtureCount += validateFixtureManifest(t, path, content)
		default:
...
func validateFixtureManifest(t *testing.T, path string, content []byte) int {
	t.Helper()
	...
	for _, fixture := range manifest.Fixtures {
		...
		if _, ok := knownFixtureMappings[fixture.MappingID]; !ok {
			t.Errorf("%s references unknown mapping %s", path, fixture.MappingID)
		}
	}
